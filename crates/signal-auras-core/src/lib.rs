...
pub use screen_state::{
    ...
    Roi, ScreenCoordinateScale, ScreenPixelFormat, ScreenSample, ScreenSampleDiagnostic,
    ScreenSampleProvider, StateTrackerDefinition, StateTrackerDefinitionSet, StateTrackerPoller,
